...
public class Constants {
	...
	public static final int num_mps = 2; // Number of particles per cell
	public static final int num_particles = (num_nodes - 1) * num_mps; // Number of total particles

	public static final boolean move_particles = true; // Move our particles in time?




	// Time properties
	public static final double tmax = 2.; // Max time to solve for
	public static final int tsteps = 200000; // Number of steps to take
	...
	public static final int record_frequency = 2000; // Number of timesteps between recording data
